//import forwardRef as an extra here
import { Component, Input, ChangeDetectionStrategy, forwardRef } from '@angular/core';
//importing necessary accessors
import {ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';

//NUMBER_CONTROL_ACCESSOR constat to allow us to use the TeslaCounterComponent as
...
export class TeslaCounterComponent implements ControlValueAccessor {
  ...
  @Input() step: number = 1;
  // minimum number allowed before disabling
  @Input() min: number;
  // max number allowed
  @Input() max: number;
  ...
  @Input() title: string = '';
  //unit to be applied next to title (degrees, mph, etc)
  @Input() unit: string = '';
  ...
  //called by the reactive from control
